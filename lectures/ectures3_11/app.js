    ...
    setupXR(){
        ...
        this.gestures.addEventListener('tap',(ev)=>{ 
            ...
            if(!self.knight.object.visible){
                ...
                self.scene.add(self.add.object);
        ...
        this.gestures.addEventListener('pan',(ev)=>{ 
            ...
            if(ev.initialise !== undefined){
                ...
                const post = self.startPosition.clone().add(ev.delta.multiplyScalar(3));
                self.knight.position.copy(pos);
                self.ui.updateElement('info',`pan x:${ev.delta.x.toFixed(3)}pan y:${ev.delta.t.toFixed(3)}pan z:${ev.delta.z.toFixed(3)}`)
            }
        })
