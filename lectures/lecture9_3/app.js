...
class App{
    ...
    createUI() {
        ...
        function showOption(){
           const options = self.questions.question[questionIndex].options;
        ...
        function showQuestion(){
            const question = self.question.questions[questionIndex];
            self.updateElement("header","Heather");
            self.updateElement("panel",question.text);
            self.updateConfig("prev","display","none");
            self.updateConfig("next","display","none");
